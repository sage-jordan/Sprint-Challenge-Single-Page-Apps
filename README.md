...
> Answer: Using a larger initial download, you can make all other page loads faster by having the information readily available.
- [x] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML
- [x] What are `controlled components` in React?
> Answer: A controlled component, opposed to an uncontrolled component, uses a 'value={}' declaration, so that the state starts and ends with React.
